...
@api_router.get("/brasil-api/fipe/modelos/{tipo}/{marca_codigo}")
...
@api_router.get("/brasil-api/fipe/anos/{tipo}/{marca_codigo}/{modelo_codigo}")
...
@api_router.get("/brasil-api/fipe/valor/{tipo}/{marca_codigo}/{modelo_codigo}/{ano_codigo}")
...
@api_router.get("/usdt/rate")
async def get_usdt_rate(current_user: User = Depends(get_current_user)):
...
@api_router.post("/usdt/calculate-fee")
...
@api_router.post("/usdt/deposit/confirm")
...
@api_router.post("/usdt/withdrawal")
...
@api_router.post("/usdt/convert-to-brl")
...
@api_router.post("/usdt/transfer-external")
...
@api_router.get("/master/usdt/pending-approvals")
async def get_pending_approvals(current_user: User = Depends(get_current_master_user)):
...
@api_router.post("/master/usdt/approve")
...
@api_router.post("/provider/availability")
...
@api_router.get("/provider/availability")
...
@api_router.delete("/provider/availability/{slot_id}")
...
@api_router.get("/provider/{provider_id}/available-slots")
...
@api_router.get("/catalog/{merchant_id}")
...
@api_router.get("/catalog/slug/{store_slug}")
...
@api_router.get("/orders/merchant/list")
...
@api_router.patch("/user/payment-methods")
...
# ============================================
# USDT RATE AND CONVERSION
# ============================================

@api_router.get("/usdt/rate")
async def get_usdt_rate():
    """Get current USDT to BRL conversion rate"""
    try:
        # Mock rate for now - in production, use real API
        # Example: CoinGecko, Binance API, etc.
        mock_rate = 5.45  # 1 USDT = 5.45 BRL (example)
